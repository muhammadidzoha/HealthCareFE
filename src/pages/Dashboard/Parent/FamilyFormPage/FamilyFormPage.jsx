...
export const FamilyFormPage = () => {
  ...
  const onSubmitData = (e) => {
    ...
    const formInputPayload = {
      ...formInput,
      selfBirthDate: JSON.parse(localStorage.getItem("formInput"))
        .selfBirthDate,
    };
    ...
    const payloads = [
      formInputPayload,
      fatherFormInputPayload,
      ...childrenPayload,
    ];
    addMembersTofamily(payloads, () => {
          ...
          <section className="flex gap-4 mx-auto justify-around items-center rounded-xl overflow-hidden py-1 px-2">
            ...
            <Button
              ...
              className={`border px-5 rounded-full  ${
                currentPage === "" && "bg-[#1b82e6] text-white"
              }`}
            >
              <MdPeopleAlt />
              Data Diri
            ...
            <Button
              ...
              className={`border px-5 rounded-full ${
                currentPage === "father" && "bg-[#1b82e6] text-white"
              }`}
            >
              <FaHeadSideCough />
              {formInput.profile.relation === "AYAH" ? "Data Ibu" : "Data Ayah"}
            </Button>
            <Button
              type="button"
              variant="secondary"
              ...
              className={`border px-5 rounded-full ${
                currentPage === "children" && "bg-[#1b82e6] text-white"
              }`}
            >
              <TbMoodKid />
              Data Anak
            ...
            <ProfileFormTemplate
              ...
              childrenResidence={
                <div className="flex items-center space-x-2">
                  <Checkbox
                    id="terms2"
                    onCheckedChange={(e) => setIsResidenceSame(e)}
                  />
                  <label
                    htmlFor="terms2"
          ...
          {currentPage === "children" && (
            <section className="p-4">
              <div className="mt-4 flex justify-between items-center">
                ...
                <Button onClick={() => addChildren(dataToAdd)}>
                  <AiOutlinePlus />
                  Tambah
                </Button>
              </div>
              {childrenFormInput.length > 0
                ? childrenFormInput.map((child, index) => {
                    return (
                      <div key={index}>
                        <ProfileFormTemplate
                          ...
                          onInputChange={(key, value, parentKey = null) =>
                            onChildrenInputForm(key, value, parentKey, index)
                          }
              ...
              {childrenFormInput.length > 0 && (
                <div className="flex justify-center">
                  <Button className="w-1/3" onClick={onSubmitData}>
                    Submit
                  </Button>
                </div>
              )}
